...
df = pd.read_csv("owid/tac_metriques.csv")
...
st.markdown("***")
image = Image.open('tousanticovid/isolement.png')
st.image(image, caption='Source : ministère de la Santé et de la Prévention')